 ...
 * @author Shiyanrox
 */
public class CreditSale extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setTitle("DistributerX: Credit Sales Report");
    ...
    private void btnLoadActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLoadActionPerformed
        ...
        this.findCredtiInvoiceByFilter(fDate, tDate);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CreditSale.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CreditSale().setVisible(true);
            }
        });
    }
 ...
 private void findCredtiInvoiceByFilter(String fDate, String tDate) {
        Invoices POobj = new Invoices();
        ArrayList<Invoices> POList = POobj.searchCreditInvoiceByDate(fDate, tDate);
        if (POList.isEmpty()) {
