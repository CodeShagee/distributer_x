 ...
 * @author Shiyanrox
 */
public class PurchaseRptVen extends javax.swing.JFrame {

    /**
     * Creates new form PurchaseRptVen
     */
    public PurchaseRptVen() {
        initComponents();
        loadComboVendor();
    }
    ...
    private void initComponents() {
        ...
        setTitle("DistributerX: Purchasing Report Vendor Vice");

        jPanel2.setBackground(new java.awt.Color(0, 153, 153));
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder("Purchaseing Report Vendor Vice"));
    ...
    private void btnLoadActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLoadActionPerformed
        ...
        this.findSalesOrderByFilter(ddlVendor.getSelectedItem().toString(),fDate, tDate);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PurchaseRptVen.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PurchaseRptVen().setVisible(true);
            }
        });
    }
