...
public class SalesReport extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setTitle("DistributerX: Sales Report");
        ...
        if (tblSales.getColumnModel().getColumnCount() > 0) {
            ...
            tblSales.getColumnModel().getColumn(1).setMaxWidth(40);
        }
    ...
    private void btnLoadActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLoadActionPerformed
        ...
        this.findInvoiceByFilter(fDate, tDate);
    ...
    private void findInvoiceByFilter(String fDate, String tDate) {
        Invoices POobj = new Invoices();
        ArrayList<Invoices> POList = POobj.searchInvoiceByDate(fDate, tDate);
        if (POList.isEmpty()) {
