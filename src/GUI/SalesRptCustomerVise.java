 ...
 * @author Shiyanrox
 */
public class SalesRptCustomerVise extends javax.swing.JFrame {

    /**
     * Creates new form SalesRptCustomerVise
     */
    public SalesRptCustomerVise() {
        initComponents();
        loadComboCustomer();
    }
    ...
    private void initComponents() {
        ...
        setTitle("DistributerX: Sales Report Customer Vice");

        jPanel2.setBackground(new java.awt.Color(0, 153, 153));
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder("Sales Report Customer Vice"));
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addComponent(ddlCustomer, javax.swing.GroupLayout.PREFERRED_SIZE, 110, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18)
        ...
        tblSales.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "#", "InvoNo", "PO NO", "Type", "Credit Period", "Customer", "Date", "Net", "Discount", "Total"
            }
        ) {
    ...
    private void btnLoadActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLoadActionPerformed
        ...
        this.findInvoiceByFilter(ddlCustomer.getSelectedItem().toString(),fDate, tDate);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SalesRptCustomerVise.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SalesRptCustomerVise().setVisible(true);
            }
        });
    }
 ...
 private void findInvoiceByFilter(String text,String fDate, String tDate) {
        Invoices POobj = new Invoices();
        ArrayList<Invoices> POList = POobj.searchGRNByFilter(text,fDate, tDate);
        if (POList.isEmpty()) {
    ...
    private void printReport() {
        ...
        try {
            ...
            String rs = "src\\RPT\\salesRpt.jrxml";
