 ...
 * @author Shiyanrox
 */
public class saleRptProduct extends javax.swing.JFrame {

    /**
     * Creates new form saleRptProduct
     */
    public saleRptProduct() {
        initComponents();
        loadComboProduct();
    }
    ...
    private void initComponents() {
        ...
        setTitle("DistributerX: Sales Report Product Vice");

        jPanel2.setBackground(new java.awt.Color(0, 153, 153));
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder("Sales Report Product Vice"));
        ...
        tblSales.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "#", "InvoNo", "PID", "Date", "Batch", "Desription", "S.Price", "Qty", "Amount"
            }
        ) {
...
if(ddlProduct.getSelectedItem()!=null)
{
    product=ddlProduct.getSelectedItem().toString();
        ...
        txtTot.setText(calNet(tblSales, 8) + "");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(saleRptProduct.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new saleRptProduct().setVisible(true);
            }
        });
    }
...
private void findInvoiceProductByFilter(String text,String fDate, String tDate) {
        InvoiceRegistry POobj = new InvoiceRegistry();
        ArrayList<InvoiceRegistry> POList = POobj.loadInvoiceRegistrybyfilter(text,fDate, tDate);
        if (POList.isEmpty()) {
            ...
            while (POList.size() > count) {
                Vector v = new Vector();
                InvoiceRegistry po = new InvoiceRegistry();
                po = POList.get(count);
...
private void printReport() {
        ...
        try {
            ...
            String rs = "src\\RPT\\saleRptProduct.jrxml";
